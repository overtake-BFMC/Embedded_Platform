...
public:
    ...
    void read_canMsg(   uint8_t buffer_sidh_addr, CAN_Message* msg);
    void write_canMsg(   uint8_t buffer_sidh_addr,  CAN_Message* msg);
    ...
    void setDebugConsole(UnbufferedSerial c);
